...
class ChartingState extends base.MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = CoolUtil.coolTextFile(Paths.txt('lists/characterList'));
		var gfVersions:Array<String> = CoolUtil.coolTextFile(Paths.txt('lists/gfVersionList'));
		var stages:Array<String> = CoolUtil.coolTextFile(Paths.txt('lists/stageList'));
		var noteStyles:Array<String> = CoolUtil.coolTextFile(Paths.txt('lists/noteStyleList'));
