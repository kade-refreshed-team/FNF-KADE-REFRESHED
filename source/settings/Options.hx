...
class DFJKOption extends Option
{
	...
	{
		menus.OptionsMenu.instance.openSubState(new menus.KeyBindMenu());
		return false;
	}
...
class ReplayOption extends Option
{
	...
	{
		trace("switch");
		FlxG.switchState(new menus.LoadReplayState());
		return false;
	}
...
class CustomizeGameplay extends Option
{
	...
	{
		trace("switch");
		FlxG.switchState(new menus.GameplayCustomizeState());
		return false;
	}
...
class OffsetMenu extends Option
{
	...
	public override function press():Bool
	{
		...
		menus.OptionsMenu.instance.openSubState(new funkin.PreloadingSubState());
		return false;
	}
